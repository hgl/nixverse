...
expectSuccess 'tests.private.nodes.node.node.final' '{"x":2,"y":3}'
expectSuccess 'tests.private.nixosConfigurations.node.config.nixverse-test' '2'
expectSuccess 'tests.private.nodes.nodes-0.node.final' '{"current":2,"currentPrivate":2,"x":2,"y":3}'
expectSuccess 'tests.private.nixosConfigurations.nodes-0.config.nixverse-test' '2'
expectSuccess 'tests.private.nodes.nodesCommon-0.node.final' '{"currentCommon":4,"currentNode":4,"x":4,"y":5}'
expectSuccess 'tests.private.nixosConfigurations.nodesCommon-0.config.nixverse-test' '4'
